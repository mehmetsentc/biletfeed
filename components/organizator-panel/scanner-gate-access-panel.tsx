      ...
      <div className="flex items-start justify-between gap-3">
        <div className="min-w-0 flex-1">
          <div className="flex items-center gap-2 text-sm font-semibold text-white">
            <KeyRound className="size-4 shrink-0 text-[var(--bf-neon)]" />
            Kapı ekibi erişimi
          </div>
          <p className="mt-1 text-xs text-white/55">
            Kod yalnızca seçili etkinlik için geçerlidir. Görevliler{' '}
            <span className="text-[var(--bf-neon)]">giris.biletfeed.com</span> üzerinden giriş yapar
            (3 gün geçerli).
          </p>
          {events.length > 0 && (
            <div className="mt-3">
      ...
      {loading ? (
        ...
        <div className="mt-3 space-y-2">
          ...
          {shareCode && (
            <div className="flex items-center justify-between gap-2 rounded-lg border border-white/10 bg-[#0c1017] px-3 py-2.5">
              <div className="min-w-0">
                ...
                <p className="font-mono text-xl font-bold tracking-[0.2em] text-[var(--bf-neon)]">
                  {shareCode}
                </p>
              </div>
              <Button
          ...
          <p className="text-[11px] text-white/45">
            Görevli <span className="text-[var(--bf-neon)]">giris.biletfeed.com</span> adresine
