...
function CategoryIcon({ icon }: { icon: SupportCategory['icon'] }) {
  ...
  return (
    <div className="flex size-12 items-center justify-center rounded-xl bg-[#f5a623]/10 text-[#f5a623]">
...
export function SupportHome({
  ...
  return (
    <div className="mx-auto max-w-5xl space-y-10 px-4 py-8 sm:px-6 sm:py-12">
      <div className="relative overflow-hidden rounded-2xl bg-gradient-to-br from-[#f5a623] via-[#f5a623] to-[#e09520] px-6 py-10 text-white shadow-lg sm:px-10">
      ...
      {!query.trim() && (
        <div className="grid gap-4 sm:grid-cols-2">
          <Link
            href="#bilgi-tabani"
            className="group flex gap-4 rounded-2xl border border-zinc-200 bg-white p-5 shadow-sm transition-all hover:border-[#f5a623]/40 hover:shadow-md"
          >
            <div className="flex size-11 shrink-0 items-center justify-center rounded-xl bg-amber-50 text-[#f5a623]">
              <BookOpen className="size-5" />
            </div>
            <div>
              <p className="font-semibold text-zinc-900 group-hover:text-[#f5a623]">
                Makalelere göz atın
              </p>
          ...
          <Link
            ...
            className="group flex gap-4 rounded-2xl border border-zinc-200 bg-white p-5 shadow-sm transition-all hover:border-[#f5a623]/40 hover:shadow-md"
          >
            <div className="flex size-11 shrink-0 items-center justify-center rounded-xl bg-[#f5a623]/10 text-[#f5a623]">
      ...
      {!query.trim() && (
        <section id="bilgi-tabani">
          <div className="mb-4">
            <h2 className="text-lg font-bold text-[#f5a623]">Bilgi tabanı</h2>
              ...
              return (
                <Link
                  ...
                  className={cn(
                    ...
                    'transition-all hover:border-[#f5a623]/40 hover:shadow-md'
                  )}
                >
      ...
      {!query.trim() && (
        <section>
          <div className="mb-4 flex items-center justify-between">
            <h2 className="text-lg font-bold text-[#f5a623]">
          ...
          <div className="grid gap-3 sm:grid-cols-2">
            {popular.map((article) => (
              <Link
                ...
                className="flex items-start gap-3 rounded-2xl border border-zinc-200 bg-white p-4 shadow-sm transition-colors hover:border-[#f5a623]/30 hover:bg-amber-50/30"
              >
                <BookOpen className="mt-0.5 size-4 shrink-0 text-[#f5a623]" />
      ...
      <div className="rounded-2xl border border-dashed border-[#f5a623]/40 bg-[#f5a623]/5 px-5 py-4 text-center text-sm text-zinc-600">
  ...
  return (
    <article className="mx-auto max-w-3xl space-y-6 px-4 py-8 sm:px-6 sm:py-12">
      ...
      <div className="flex flex-wrap gap-3">
        ...
        <Link
          href={supportHref('/destek-talebi')}
          className="inline-flex h-9 items-center rounded-md bg-[#f5a623] px-4 text-sm font-semibold text-white hover:opacity-90"
        >
          Destek talebi gönder
        </Link>
      </div>
      ...
      <ul className="divide-y divide-zinc-100 overflow-hidden rounded-2xl border border-zinc-200 bg-white shadow-sm">
        {articles.map((a) => (
          <li key={a.slug}>
            ...
            >
              <BookOpen className="size-4 shrink-0 text-[#f5a623]" />
              <div>
