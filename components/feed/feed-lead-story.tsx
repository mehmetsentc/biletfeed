...
function badgeClass(categorySlug: string | null): string {
    ...
    >
      ...
      <div className="flex flex-col justify-center p-5 sm:p-6 md:p-8">
        <div className="mb-3 flex flex-wrap items-center gap-2">
          <span
            className={cn(
              'rounded-md px-2.5 py-1 text-[11px] font-semibold tracking-wide text-white',
              badgeClass(post.categorySlug)
            )}
          >
            {label}
          </span>
