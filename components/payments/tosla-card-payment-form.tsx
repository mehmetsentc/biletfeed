...
export function ToslaCardPaymentForm({
  ...
  function submitToTosla() {
    ...
    // urlencoded — multipart bazı WebView/Safari yollarında boş indirmeye yol açabiliyor
      ...
      >
        ...
        <div className="mt-4 flex items-start gap-2 rounded-lg bg-muted/40 px-3 py-2.5 text-xs text-muted-foreground">
          ...
          <p>
            ...
            altyapısına gönderilir. Ardından bankanızın 3D Secure doğrulaması uygulama içinde açılır.
          </p>
        </div>
