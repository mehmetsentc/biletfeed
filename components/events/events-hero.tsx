...
export function EventsHeroTablet() {
  return (
    <section className="hidden border-b border-border bg-muted/30 px-6 py-8 md:block xl:hidden">
...
export function EventsHeroDesktop() {
  return (
    <section className="hidden border-b border-border bg-muted/30 py-12 xl:block">
