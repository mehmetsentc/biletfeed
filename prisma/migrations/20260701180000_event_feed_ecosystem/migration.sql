-- CreateEnum
CREATE TYPE "FeedPostStatus" AS ENUM ('discovered', 'processing', 'review', 'scheduled', 'published', 'rejected', 'archived');
CREATE TYPE "FeedPostType" AS ENUM ('concert_news', 'festival_news', 'music_news', 'entertainment_news', 'artist_news', 'event_announcement', 'behind_the_scenes', 'event_recap', 'top_list', 'weekend_guide', 'city_guide', 'venue_guide', 'ticket_alert', 'trending_story', 'ai_opinion', 'interview', 'photo_story', 'video_story', 'organizer_update');
CREATE TYPE "FeedEditorialStage" AS ENUM ('discovery', 'duplicate_check', 'analysis', 'rewrite', 'seo', 'categorization', 'tagging', 'image_selection', 'review', 'publish');
CREATE TYPE "FeedMediaType" AS ENUM ('image', 'video', 'embed', 'reel');
CREATE TYPE "FeedQueueStatus" AS ENUM ('pending', 'processing', 'completed', 'failed', 'rejected', 'duplicate');
