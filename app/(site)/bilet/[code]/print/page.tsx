...
export default async function TicketPrintPage({ params, searchParams }: Props) {
  ...
  // If invitation, redirect to invitation print page
      ...
      <div style={{
        ...
        {!ticket.event.coverImage && (
          <div style={{
            ...
            <span style={{ fontSize: 11, fontWeight: 700, letterSpacing: 2, color: '#000', textTransform: 'uppercase' }}>
              Etkinlik Bileti
            </span>
          </div>
        )}
        ...
        <div style={{ padding: '28px 32px' }}>
          ...
          <div style={{
            ...
            {[
              ...
              <div key={label} style={{
                ...
                <p style={{ fontSize: 10, color: '#f5a623', fontWeight: 700, letterSpacing: 1, textTransform: 'uppercase', marginBottom: 3 }}>
                  {label}
                </p>
          ...
          <div style={{ position: 'relative', margin: '28px -32px' }}>
            <div style={{
              ...
              background: '#151b24', border: '2px solid rgba(245,166,35,0.2)'
            }} />
            <div style={{
          ...
          <div style={{ display: 'flex', gap: 28, alignItems: 'center' }}>
            ...
            {/* Right side info */}
            <div style={{ flex: 1 }}>
              <p style={{ fontSize: 10, color: 'rgba(255,255,255,0.4)', letterSpacing: 1, textTransform: 'uppercase', marginBottom: 6 }}>
                Bilet Kodu
              </p>
              <p style={{ fontSize: 20, fontWeight: 800, letterSpacing: 4, color: '#fff', fontFamily: 'monospace', marginBottom: 16 }}>
                {ticket.ticketCode}
              </p>
