...
export const SEED_CATEGORIES: SeedCategory[] = [
  ...
  { slug: 'organizator-haklari', icon: 'scale', titleTr: 'Organizatör Hakları', titleEn: 'Organizer Rights', sortOrder: 19 },
  { slug: 'ticari', icon: 'store', titleTr: 'Ticari Faaliyet', titleEn: 'Commercial Activity', sortOrder: 20 },
